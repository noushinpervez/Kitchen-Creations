        ...
        <div className="bg-banner-bg bg-cover bg-center rounded-3xl hero min-h-screen">
            <div className="hero-content text-center text-neutral-content">
                <div className="lg:w-4/5 w-11/12">
                    ...
                    <p className="mb-5 lg:mb-10 text-base lg:text-lg lg:leading-8">A progression of rare and beautiful ingredients where texture, flavour and harmony is paramount. Delve into the Kitchen Creations dining experience with our recipes.</p>
                    <div className="flex gap-2 lg:gap-6 justify-center">
                        <a href="#our-recipes"><button className="btn glass bg-buttonColor rounded-full hover:border-none hover:text-white hover:ring-buttonColor hover:ring-2 font-semibold lg:text-xl px-4 lg:px-8 lg:py-5 h-full transition-all duration-300 ease-in hover:bg-transparent">Explore Now</button></a>
